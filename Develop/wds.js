...
function elevenBlock(){
    ...
    let save = document.getElementById("11btn");
...
function thirteenBlock(){
    ...
    let save = document.getElementById("13btn");
...
function fourteenBlock(){
    ...
    let save = document.getElementById("14btn");
...
function fifteenBlock(){
    ...
    let save = document.getElementById("15btn");
...
function sixteenBlock(){
    ...
    let save = document.getElementById("16btn");
...
function seventeenBlock(){
    ...
    let save = document.getElementById("17btn");
